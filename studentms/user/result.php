...
<html lang="en">
    <head>
       <!-- Title -->
       <title>Student  Management System|| view Student Result</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> View Student Result </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> View Student Result</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">View Student Result</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View  Result</a>
                    </div>
<?php
// code Student Data
$rollid=$_POST['rollid'];
