...
$sql="update tblleavess set IsRead=:isread where id=:did";
...
date_default_timezone_set('Asia/Kolkata');
$admremarkdate=date('Y-m-d G:i:s ', strtotime("now"));
$sql="update tblleavess set AdminRemark=:description,Status=:status,AdminRemarkDate=:admremarkdate where id=:did";
$query = $dbh->prepare($sql);
...
$sql = "SELECT tblleavess.id as lid,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.StuID,tblstudent.StudentId,tblstudent.Gender,tblstudent.ContactNumber,tblstudent.ClassId,tblleavess.LeaveType,tblleavess.ToDate,tblleavess.FromDate,tblleavess.Description,tblleavess.PostingDate,tblleavess.Status,tblleavess.AdminRemark,tblleavess.AdminRemarkDate from tblleavess join tblstudent on tblleavess.stuid=tblstudent.StudentId where tblleavess.id=:lid";
$query = $dbh -> prepare($sql);
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Student Name :</b></td>
                                              <td><a href="editemployee.php?empid=<?php echo htmlentities($result->StudentId);?>" target="_blank">
                                                <?php echo htmlentities($result->StudentName);?></a></td>
                                              <td style="font-size:16px;"><b>StudentID :</b></td>
                                          ...
                                          <tr>
                                             <td style="font-size:16px;"><b>StudentEmail :</b></td>
