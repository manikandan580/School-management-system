...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Student  Management System|| Pending Leave</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Pending Leaves</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View Pending Leaves</a>
                    </div>
