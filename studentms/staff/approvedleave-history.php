...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Student  Management System|| Approved Leave</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> approved leaves </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">approved Leaves</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View approved Leaves</a>
                    </div>
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td> <b><?php echo htmlentities($cnt);?></b></td>
                                              <td><a href="edit-student-details.php?stuid=<?php echo htmlentities($result->StudentId);?>" target="_blank"><?php echo htmlentities($result->StudentName);?>(<?php echo htmlentities($result->StuID);?>)</a></td>
